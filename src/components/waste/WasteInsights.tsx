...
export const WasteInsights: React.FC<WasteInsightsProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs text-stone-400 font-semibold uppercase">Potensi Hemat</span>
            <ShieldCheck className="w-4 h-4 text-emerald-400" />
          </div>
          <p className="text-xl font-bold text-emerald-400">{formatRupiah(preventableCost)}</p>
        ...
        <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs text-stone-400 font-semibold uppercase">Kategori Kritis</span>
            <AlertTriangle className="w-4 h-4 text-rose-400" />
          </div>
          <p className="text-xl font-bold text-stone-100">{topCat ? topCat[0] : '-'}</p>
          <p className="text-xs text-stone-300">
        ...
        <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs text-stone-400 font-semibold uppercase">Shift Paling Rawan</span>
            <Lightbulb className="w-4 h-4 text-amber-400" />
          </div>
          <p className="text-xl font-bold text-stone-100">{topShift ? topShift[0] : '-'}</p>
          <p className="text-xs text-stone-300">
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-r from-stone-900 via-stone-900 to-amber-950/30 border border-amber-900/40 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-stone-300">
          <div className="p-3 bg-stone-950/60 rounded-xl border border-stone-800 space-y-1">
            <p className="font-bold text-stone-200">1. Aturan Pitcher Susu (Milk Jug Size)</p>
          ...
          <div className="p-3 bg-stone-950/60 rounded-xl border border-stone-800 space-y-1">
            <p className="font-bold text-stone-200">2. Kalibrasi Grinder / Dial-in Terjadwal</p>
            <p className="text-stone-400">
          ...
          <div className="p-3 bg-stone-950/60 rounded-xl border border-stone-800 space-y-1">
            <p className="font-bold text-stone-200">3. Label FIFO & Rotasi Chiller</p>
            <p className="text-stone-400">
          ...
          <div className="p-3 bg-stone-950/60 rounded-xl border border-stone-800 space-y-1">
            <p className="font-bold text-stone-200">4. Batch Baking Pastry Bertahap</p>
            <p className="text-stone-400">
